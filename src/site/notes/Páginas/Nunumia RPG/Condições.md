...
# Paralisia
O personagem fica imóvel e indefeso e só pode realizar ações que envolvam a mente.
# Paralisia Mental
O personagem fica completamente paralisado mentalmente dessa forma caindo no chão e não podendo realizar nenhuma ação. Para retirar essa condição é necessário realizar um teste de Medicina (DT 14) 
# Petrificado
